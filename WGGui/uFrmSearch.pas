...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, uBaseFrame, Vcl.ExtCtrls, AdvUtil, Vcl.StdCtrls, Vcl.Grids, AdvObj, BaseGrid, AdvGrid, udm,
    DosCommand, Vcl.Buttons, System.ImageList, Vcl.ImgList;
...
begin
  ...
  DosCommand1.CommandLine := format(sSearchCMD, [sSearch]);
